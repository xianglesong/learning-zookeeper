...
/**
 * An example of the PathChildrenCache. The example "harness" is a command processor that allows
 * adding/updating/removed nodes in a path. A PathChildrenCache keeps a cache of these changes and
 * outputs when updates occurs.
 */
public class PathCacheExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      client =
          CuratorFrameworkFactory.newClient(server.getConnectString(), new ExponentialBackoffRetry(
              1000, 3));
      client.start();
